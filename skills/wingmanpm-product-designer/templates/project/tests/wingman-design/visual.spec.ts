...
for (const width of viewports) {
  test(`Concept demo contract at ${width}px`, async ({ page }) => {
...
test('keyboard and reduced motion remain usable', async ({ page }) => {
  ...
  await page.goto('/iframe.html?id=concept-demo-tamarack-fieldops--reduced-motion&viewMode=story&globals=theme:dark');
